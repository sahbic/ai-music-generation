...
class Autoencoder:
    """
    Autoencoder represents a Deep Convolution autoencoder architecture with mirrored encoder and decoder components.
    """
    ...
    def _add_bottleneck(self, x):
        """Flatten and add bottleneck (Dense Layer)"""
        self._shape_before_bottleneck = K.int_shape(x)[1:] # ([2,) [7, 7, 32] ignore the batch size
        x = Flatten()(x)
